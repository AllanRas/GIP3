...
namespace Lekkerbek12Gip.Controllers
{
    public class BestellingsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,OrderDate,Total,KlantId")] Bestelling bestelling)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,OrderDate,Total,KlantId")] Bestelling bestelling)
        {
            if (id != bestelling.Id)
            {
                return NotFound();
